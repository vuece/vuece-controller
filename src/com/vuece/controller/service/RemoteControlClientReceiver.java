...
public class RemoteControlClientReceiver extends BroadcastReceiver {
    private static final String TAG = "vuece/RemoteControlClientReceiver";
                    ...
                    switch (event.getAction())
                    {
                        ...
                        case KeyEvent.ACTION_UP:
                            ...
                            if (time - mHeadsetDownTime >= 1000) {
                                i = new Intent(ControllerService.ACTION_REMOTE_BACKWARD);
                                time = 0;
                                // double click
                            } else if (time - mHeadsetUpTime <= 500) {
                                i = new Intent(ControllerService.ACTION_REMOTE_FORWARD);
                            }
                            // one click
                            else {
//                                if (mLibVLC.isPlaying())
//                                    i = new Intent(ControllerService.ACTION_REMOTE_PAUSE);
//                                else
                                    i = new Intent(ControllerService.ACTION_REMOTE_PLAYPAUSE);
                            }
                            mHeadsetUpTime = time;
                            break;
                    }
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    i = new Intent(ControllerService.ACTION_REMOTE_PLAY);
                    break;
                case KeyEvent.KEYCODE_MEDIA_PAUSE:
                    i = new Intent(ControllerService.ACTION_REMOTE_PAUSE);
                    break;
                case KeyEvent.KEYCODE_MEDIA_STOP:
                    i = new Intent(ControllerService.ACTION_REMOTE_STOP);
                    break;
